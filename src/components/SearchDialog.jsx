...
const searchData = [
  {
    ...
    path: '/',
    keywords: ['home', 'cv', 'resume', 'start', 'welcome', 'portfolio', 'shiv', 'Shiv Kumar Rana', 'shivrana992', 'software developer', 'full stack developer', 'mern stack', 'web developer'],
  },
  {
    title: 'About',
    description: 'Learn more about me and my background',
    path: '/about',
    keywords: ['about', 'background', 'education', 'bio', 'profile', 'cv', 'resume', 'shiv', 'rana', 'full stack developer', 'software engineer', 'web developer'],
  },
  {
    title: 'Education',
