      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-12">
          ...
          <div className="space-y-2">
            <Link to="/" className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-white">Shiv Kumar Rana</span>
            </Link>
            <p className="text-sm text-gray-400">
              Student at NIT, Trichy, Tamil Nadu
            </p>
          </div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  aria-label="Email Shiv Kumar Rana"
                >
              ...
              <li>
                <a
                  ...
                  className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                  aria-label="Call Shiv Kumar Rana"
                >
        ...
        <div className="border-t border-white/10 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              © {currentYear} Shiv Kumar Rana. All rights reserved.
            </p>
